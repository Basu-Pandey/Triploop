    ...
    <HomeAboutUsWrapper>
      <div className="about-us-section">
        <div className="about-us-content">
          ...
          <h1>Let’s know about our journey For Triploop -Your Gateway To Wanderlust</h1>
